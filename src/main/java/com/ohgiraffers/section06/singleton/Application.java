...
public class Application {
    public static void main(String[] args) {
        ...
        *      두 번째 이용시에는 인스턴스 생성 시간 없이 사용할 수 있다.(두번쨰부터는 생성할 필요없다는 말)
...
//        int b = 10;         // 이른 초기화(선언과 동시에 바로 값지정)
...
//        EagerSingleton eager = new EagerSingleton();
        ...
        EagerSingleton eager2 = EagerSingleton.getInstance();  //getInstance는 public으로 간접적으로 또 만들어줘서 접근가능

        System.out.println("eager1 의 hashcode : " + eager1.hashCode());
        System.out.println("eager2 의 hashcode : " + eager2.hashCode());
        // 불러오는게 getInstance 이고, 한 개로 공유하고 있음을 보여주고 있다.(hashcode 동일함)
        // 따라서 static 키워드를 주의해야한다.(얕은복사)
