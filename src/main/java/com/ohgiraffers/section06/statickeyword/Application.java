...
public class Application {
    public static void main(String[] args) {
        ...
        /* 필기.
        *   static
        *   : 정적(이미 있다./ 미리 할당됨) 메모리 영역에 프로그램이 start 될 때 할당을 하는 키워드이다.
        ...
        *   인스턴스를 생성할 때 마다 기본값인 0으로 초기화가 되었다.
        ...
        * */
        StaticFieldTest sft2 = new StaticFieldTest();          // 새로운 객체 생성~
        System.out.println("non-static field : " + sft2.getNonStaticCount());       //0
        System.out.println("static field : " + sft2.getStaticCount());              //1
        // 새로운 객체를 만들면서, static은 프로그램을 유지되게 해준다.
        // 따라서 下는(static) 새로운 객체가 생성되었어도 여전히 이전 값인 1인 것이다.
