...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /*목차. 1. 변수를 이용한 회원데이터 관리 */             // 다른 자료형도 하나로 묶어서 새로운 타입으로 제공함 예시(클래스)
        String id = "user01";
        String pwd = "pass01";
        String name = "조평훈 ";
        int age = 20;
        char gender = '남';
        String[] hobby = new String[] {"야구", "배드민턴", "탁구"};   //여러개여서 배열로!!(for문 필요)
        ...
        *   즉, 클래스에 작성한 내용대로 사용할 수 있다.
        * */

        Member member = new Member();         // ◀ 클래스 자체의 Member를 불러온 것
        ...
        *   '.' 참조연산자라고 하는데, 래퍼런스 변수가 참조하고 있는 주소로 접근한다 라는 의미.
        *   각 공간은 필드명으로 접근한다.
        * */
        ...
        System.out.println("memeber. age : " + member.age);
        System.out.println("member. gender : " + member.gender);          // 유니코드
