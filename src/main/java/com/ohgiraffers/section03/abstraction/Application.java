...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 필기.
        *   객체를 설계하기 위해서는 복잡한 현실 세계를 반영하기에는 너무 방대하고 복잡하기 대문에
        *   현실세계를 프로그램의 목적에 맞게 단순화하는 '추상화' 라는 기법을 적용하게 된다.
        * */
        ...
        *       그 객체를 구현하는 방법으로 설계한 대로 클래스를 작성한 것이다.
        *  */
        ...
        *   2. 자동차는 시동걸기, 앞으로 가기, 멈추기, 시동끄기 할 수 있다.
        *   3. 자동차는 처음에 멈춘 상태로 있는다.
        *   4. 카레이서는 먼저 자동차에 시동을 건다. 이미 시동이 걸려있으면 다시 시동을 걸 수 없다.
        *   5. 카레이서는 엑셀레이터를 밟으면 시동 걸렸다면 자동차는 시속이 10k/h 증가하며 앞으로 나간다.
        ...
        *   - 4. 시동을 꺼라
        *
        *  목차. 3. 커뮤니케이션 다이어그램(동적_움직이는 흐름을 보자~!!)
        *   1. 시동 걸기
        ...
        * */
        ...
        /* 스캐너 입력: 입력 받은 메뉴에 따라 카레이서의 행동이 달라집니다. */
        Scanner sc = new Scanner(System.in);

        //조건이 많아서 switch 문으로 작성하기~~
        while (true) {
            ...
            switch (no){
                ...
                default:                    // * (if else같은) 조건에 맞지 않는 것을 입력했을때, 실행됨
                    System.out.println("잘못된 번호를 입력했습니다."); break;
            }

            if(no == 9){                    // 9번 입력했을때 while 문 탈출!
